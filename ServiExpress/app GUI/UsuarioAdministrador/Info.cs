...
namespace ServiExpress.app_GUI.UsuarioAdministrador
{
    public partial class Info : Form
    {
        ...
        public Info(ControladorAdministrador controladorAdministrador)
        {
        ...
        {
            usuario resultado = controladorAdministrador.GetInfoUsuario(this.controladorAdministrador.login[0]);
            if (resultado != null)
            {
