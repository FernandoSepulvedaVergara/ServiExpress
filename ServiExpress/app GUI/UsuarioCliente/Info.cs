...
{ 
    public partial class Info : Form
    {
        ...
        public Info(ControladorCliente controladorCliente)
        {
        ...
        {
            usuario resultado = controladorCliente.GetInfoUsuario(this.controladorCliente.login[0]);
            if (resultado != null)
            {
        ...
        private void BtnGuardarDatos_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        string[] resultado = controladorCliente.ActualizarUsuario(actualizarUsuario);
                        if (bool.Parse(resultado[0]))
                        {
                            ...
                            controladorCliente.login = login;
                            GetInfoUsuario();
        ...
        private void BtnActualizarCancelar_Click(object sender, EventArgs e)
        {
            if (BtnActualizarCancelar.Text.Equals("Actualizar datos"))
            {
                ...
                region[] regiones = controladorCliente.GetRegiones();
        ...
        private void CmbRegion_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            comuna[] comunas = controladorCliente.GetComunas(idRegion);
            CmbComuna.Items.Clear();
